  ...
  },
  {
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        javascript = { "biomejs", lsp_format = "never" },
        javascriptreact = { "biomejs", lsp_format = "never" },
        lua = { "stylua" },
        ...
        typescript = { "biomejs", lsp_format = "never" },
        typescriptreact = { "biomejs", lsp_format = "never" },
